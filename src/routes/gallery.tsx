  ...
  head: () => ({
    meta: [
      { title: "Community Gallery — PrimalCanvas" },
      {
        name: "description",
        content:
          "Browse stencils published by the PrimalCanvas community. Like, remix, and download.",
      },
    ...
    <div className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-30 border-b border-border bg-background/85 backdrop-blur-xl">
        <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
          ...
          <Link to="/vault" className="text-sm text-muted-foreground hover:text-foreground">
            My Vault
          </Link>
        </div>
      </header>
        ...
        {items === null ? (
          ...
          <div className="border border-dashed border-border rounded-xl p-12 text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Be the first to publish from the Studio.
            </p>
          </div>
        ) : (
