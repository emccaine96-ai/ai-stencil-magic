...
export const GRADIENT_PRESETS: { id: string; name: string; g: Gradient }[] = [
  ...
  { id: "purple-ink",   name: "Purple Ink",   g: grad([0, "#0d0620"], [0.5, "#7c3aed"], [1, "#f5e6ff"]) },
  { id: "teal-orange",  name: "Teal/Orange",  g: grad([0, "#0b3b52"], [0.5, "#1c8a7a"], [1, "#ffb457"]) },
  ...
  { id: "sunset",       name: "Sunset",       g: grad([0, "#1a0033"], [0.4, "#c02455"], [0.75, "#ff8a3d"], [1, "#ffe37a"]) },
  { id: "arctic",       name: "Arctic",       g: grad([0, "#0a1226"], [0.5, "#4a86e8"], [1, "#eaf6ff"]) },
  { id: "blue-carbon",  name: "Blue Carbon",  g: grad([0, "#0a0f2e"], [0.5, "#2b3a8c"], [1, "#f0f3ff"]) },
