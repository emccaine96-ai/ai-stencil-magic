...
export const BUILTIN_BRUSHES: Brush[] = [
  ...
  },
  {
    ...
    params: mk({
      ...
      hardness: 0.7,
      jitter: 0.2,
      angleRandomness: 0.15,
      pressureSize: 0.6,
      pressureOpacity: 0.4,
      texturePattern: "bristle_lines",
      textureDepth: 0.85,
    }),
  ...
  },
  {
    ...
    params: mk({
      ...
      spacing: 0.05,
      hardness: 0.8,
      angleRandomness: 0.05,
      pressureSize: 0.55,
      pressureOpacity: 0.2,
      texturePattern: "canvas_weave",
      textureDepth: 0.55,
    }),
