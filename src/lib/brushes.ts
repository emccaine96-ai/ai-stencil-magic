...
export const DEFAULTS: Record<BrushId, Omit<BrushSettings, "color">> = {
  ...
  // Tranche 2
  "technical-pen":   { id: "technical-pen",   size: 3,  opacity: 1.0, flow: 1.0, spacing: 0.02, hardness: 1.0,  scatter: 0, rotationJitter: 0, pressureSize: 0.05, pressureOpacity: 0.0, pressureCurve: 1.0 },
  "brush-pen":       { id: "brush-pen",       size: 22, opacity: 1.0, flow: 1.0, spacing: 0.03, hardness: 1.0,  scatter: 0, rotationJitter: 0, pressureSize: 0.95, pressureOpacity: 0.2, pressureCurve: 1.3 },
  "dip-pen":         { id: "dip-pen",         size: 10, opacity: 1.0, flow: 1.0, spacing: 0.03, hardness: 1.0,  scatter: 0, rotationJitter: 0, pressureSize: 0.85, pressureOpacity: 0.2, pressureCurve: 1.2 },
  "fountain-pen":    { id: "fountain-pen",    size: 8,  opacity: 1.0, flow: 0.95,spacing: 0.03, hardness: 0.9,  scatter: 0, rotationJitter: 0, pressureSize: 0.7,  pressureOpacity: 0.3, pressureCurve: 1.1 },
  "hb-pencil":       { id: "hb-pencil",       size: 10, opacity: 0.7, flow: 0.55,spacing: 0.04, hardness: 0.85, scatter: 1, rotationJitter: 1, pressureSize: 0.7,  pressureOpacity: 0.85,pressureCurve: 1.1 },
  "pencil-6b":       { id: "pencil-6b",       size: 18, opacity: 0.95,flow: 0.8, spacing: 0.04, hardness: 0.75, scatter: 1, rotationJitter: 1, pressureSize: 0.6,  pressureOpacity: 0.5, pressureCurve: 0.9 },
  "colored-pencil":  { id: "colored-pencil",  size: 12, opacity: 0.8, flow: 0.6, spacing: 0.04, hardness: 0.9,  scatter: 1, rotationJitter: 1, pressureSize: 0.6,  pressureOpacity: 0.7, pressureCurve: 1.0 },
  "conte-crayon":    { id: "conte-crayon",    size: 28, opacity: 0.85,flow: 0.7, spacing: 0.06, hardness: 0.8,  scatter: 2, rotationJitter: 1, pressureSize: 0.6,  pressureOpacity: 0.6, pressureCurve: 1.0 },
  "oil-flat":        { id: "oil-flat",        size: 36, opacity: 1.0, flow: 0.85,spacing: 0.04, hardness: 1.0,  scatter: 0, rotationJitter: 0, pressureSize: 0.6,  pressureOpacity: 0.3, pressureCurve: 1.0 },
  "oil-round":       { id: "oil-round",       size: 30, opacity: 1.0, flow: 0.8, spacing: 0.04, hardness: 0.9,  scatter: 1, rotationJitter: 0, pressureSize: 0.6,  pressureOpacity: 0.3, pressureCurve: 1.0 },
  "palette-knife":   { id: "palette-knife",   size: 50, opacity: 1.0, flow: 0.9, spacing: 0.05, hardness: 1.0,  scatter: 0, rotationJitter: 0, pressureSize: 0.5,  pressureOpacity: 0.2, pressureCurve: 1.0 },
  "gouache":         { id: "gouache",         size: 32, opacity: 1.0, flow: 1.0, spacing: 0.04, hardness: 1.0,  scatter: 0, rotationJitter: 0, pressureSize: 0.4,  pressureOpacity: 0.1, pressureCurve: 1.0 },
  "acrylic-dry":     { id: "acrylic-dry",     size: 34, opacity: 0.85,flow: 0.6, spacing: 0.05, hardness: 0.9,  scatter: 2, rotationJitter: 1, pressureSize: 0.5,  pressureOpacity: 0.6, pressureCurve: 1.0 },
  "pastel-soft":     { id: "pastel-soft",     size: 40, opacity: 0.75,flow: 0.55,spacing: 0.06, hardness: 0.6,  scatter: 2, rotationJitter: 1, pressureSize: 0.5,  pressureOpacity: 0.7, pressureCurve: 0.9 },
  "glitch-stripe":   { id: "glitch-stripe",   size: 36, opacity: 0.9, flow: 0.9, spacing: 0.5,  hardness: 1.0,  scatter: 6, rotationJitter: 0, pressureSize: 0.3,  pressureOpacity: 0.0, pressureCurve: 1.0 },
  "chromatic-fringe":{ id: "chromatic-fringe",size: 30, opacity: 0.85,flow: 0.85,spacing: 0.06, hardness: 0.7,  scatter: 0, rotationJitter: 0, pressureSize: 0.4,  pressureOpacity: 0.2, pressureCurve: 1.0 },
  "bokeh-dots":      { id: "bokeh-dots",      size: 46, opacity: 0.7, flow: 0.6, spacing: 0.5,  hardness: 0.3,  scatter: 10,rotationJitter: 1, pressureSize: 0.4,  pressureOpacity: 0.4, pressureCurve: 1.0 },
  "stars-sparkle":   { id: "stars-sparkle",   size: 26, opacity: 1.0, flow: 0.9, spacing: 0.5,  hardness: 1.0,  scatter: 8, rotationJitter: 1, pressureSize: 0.4,  pressureOpacity: 0.3, pressureCurve: 1.0 },
  "lightning-bolt":  { id: "lightning-bolt",  size: 34, opacity: 1.0, flow: 1.0, spacing: 0.8,  hardness: 1.0,  scatter: 0, rotationJitter: 1, pressureSize: 0.3,  pressureOpacity: 0.2, pressureCurve: 1.0 },
  "smoke-puff":      { id: "smoke-puff",      size: 70, opacity: 0.35,flow: 0.3, spacing: 0.15, hardness: 0.1,  scatter: 8, rotationJitter: 1, pressureSize: 0.5,  pressureOpacity: 0.6, pressureCurve: 0.8 },
  "confetti":        { id: "confetti",        size: 32, opacity: 1.0, flow: 0.9, spacing: 0.4,  hardness: 1.0,  scatter: 10,rotationJitter: 1, pressureSize: 0.4,  pressureOpacity: 0.2, pressureCurve: 1.0 },
};
