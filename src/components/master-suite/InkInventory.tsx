    ...
    <div className="space-y-3 text-sm">
      <div className="flex items-center gap-2">
        ...
        >
          {loading ? (
            ...
            <>
              <Droplet size={12} /> Extract palette
            </>
          )}
        </button>
      </div>
      {matches ? (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-[10px] text-muted-foreground font-mono">
                  {m.inkHex.toUpperCase()} · ΔE {m.deltaE.toFixed(1)}
                </div>
              </div>
        ...
        <p className="text-[10px] text-muted-foreground">
          Runs k-means++ on your uploaded photo, then matches each cluster to the closest real ink
          (Solid Ink / Eternal / Fusion / Intenze) by CIEDE2000.
        </p>
      )}
    </div>
  );
