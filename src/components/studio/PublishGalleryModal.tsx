    ...
    <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4">
      <div className="bg-card border border-border rounded-xl w-full max-w-md p-5 space-y-4">
        ...
        <img
          src={thumbnail}
          alt=""
          className="w-full rounded border border-border max-h-60 object-contain bg-muted"
        />
        <input
          value={title}
        ...
        <textarea
          ...
          placeholder="Describe your stencil (optional)"
        ...
        <div className="flex justify-end gap-2">
          <button onClick={onClose} className="text-sm text-muted-foreground px-3 py-1.5">
            Cancel
          </button>
          <button
            onClick={submit}
